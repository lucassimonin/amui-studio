...
Site : **amuï studio** (portfolio one-page minimaliste), généré depuis le starter kit agence. MySQL sur le port **3307** (cohabite avec starter-kit).
...
│   └── Type/                    # hero_split, project_grid, split_intro, contact_simple, rich_text
├── Controller/
